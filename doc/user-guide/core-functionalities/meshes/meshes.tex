...
called \inlsh{\ddash{visualize}}. This will allow us to 
visualize the mesh either in 2D or 3D. 
%
\lstinputlisting[caption=Generating a mesh starting from a grid 
in \Atlas using C++, style=CStyle, label=code-meshes-C]{meshes-Reduced.cc}
%
...
%
\lstinputlisting[caption=Generating a mesh starting from a grid 
in \Atlas using Fortran, style=FStyle, label=code-meshes-F]{meshes-Reduced.F90}
%
Once defined the command-line behaviour, we first create 
