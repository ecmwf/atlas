...
void memcpy_host_to_device_2D(
    ...
    [[maybe_unused]] std::size_t host_pitch_bytes /*stride in bytes to next contiguous chunk on host*/,
    [[maybe_unused]] std::size_t width_bytes /*bytes of contiguous chunk*/,
    [[maybe_unused]] std::size_t height_count /*count of contiguous chunks*/, [[maybe_unused]] stream_view s) {
    if (device_ptr == host_ptr) {
        if (LOG) {
            std::cout
...
void memcpy_device_to_host_2D(
    void* host_ptr, [[maybe_unused]] std::size_t host_pitch_bytes /*stride in bytes to next contiguous chunk on host*/,
