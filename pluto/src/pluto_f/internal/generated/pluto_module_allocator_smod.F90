...
module procedure pluto_allocator_init_type
    this%memory_resource%c_memory_resource = resource%c_memory_resource
end procedure

module procedure pluto_allocator_init_name
    this%memory_resource = pluto_get_registered_resource(resource)
end procedure
