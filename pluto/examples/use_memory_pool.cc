...
int main([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) {
    ...
    if (pinning) {
        memory_pool = std::make_unique<pluto::MemoryPoolResource>(std::make_unique<pluto::TraceMemoryResource>(
            "pinned_upstream", std::make_unique<pluto::PinnedMemoryResource>()));
    }
    else {
        memory_pool =
            std::make_unique<pluto::MemoryPoolResource>(std::make_unique<pluto::TraceMemoryResource>("upstream"));
    }
