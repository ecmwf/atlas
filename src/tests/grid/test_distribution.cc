...
CASE( "test_nbands" ) 
{
  ...
  atlas::grid::Distribution dist (grid, atlas::util::Config ("type", "checkerboard") | Config ("bands", nproc));
...
CASE( "test_light" ) 
{
  ...
  atlas::grid::Distribution dist1 (grid, atlas::util::Config ("type", "checkerboard") | Config ("bands", nproc));
