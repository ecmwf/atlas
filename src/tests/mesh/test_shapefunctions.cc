...
//-----------------------------------------------------------------------------
  ...
  public:
    ...
    atlas::array::ArrayT<DATA_TYPE> create_field(int idx1=IDX_NOTUSED, int idx2=IDX_NOTUSED, int idx3=IDX_NOTUSED, int idx4=IDX_NOTUSED, int idx5=IDX_NOTUSED, int idx6=IDX_NOTUSED, int idx7=IDX_NOTUSED)
    {
      atlas::array::ArrayShape shape; shape.reserve(7);
  ...
  template <typename DATA_TYPE>
  IndexView<DATA_TYPE,2> make_IndexView(atlas::array::ArrayT<DATA_TYPE>& array, NewFunctionSpace& elements, int element_type_index)
  {
