...
CASE("test 3d cubic interpolation") {
    ...
    SECTION("official version") {
        ...
        Interpolation interpolation(option::type("structured-cubic3D") | matrix_free, fs, departure_points);
    ...
    SECTION("SL-like") {
        ...
        Interpolation interpolation(option::type("structured-cubic3D") | matrix_free, fs, dp_field);
