...
Mesh* atlas__generate_mesh(grid::detail::grid::Structured* rgg)
{
...
Mesh* atlas__generate_mesh_with_distribution(grid::detail::grid::Structured* rgg, grid::GridDistribution* distribution)
{
