...
class NoConnectivityMeshGenerator : public MeshGenerator::Implementation {
public:
    NoConnectivityMeshGenerator();
    NoConnectivityMeshGenerator( const eckit::Parametrisation& p );

    virtual ~NoConnectivityMeshGenerator() override;
