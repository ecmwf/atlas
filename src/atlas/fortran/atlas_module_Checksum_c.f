...
function Checksum__execute_int32_r1(this, loc_field_data) result(checksum)
  ...
  type(c_ptr) :: checksum_c_str
  integer :: lstrides(1), lextents(1), lrank=1
  lstrides = (/ stride(loc_field_data,2) /)
  lextents = (/ 1                        /)
  checksum_c_str = atlas__Checksum__execute_strided_int( this%private%object, &
    &  loc_field_data, lstrides, lextents, lrank )
  checksum = c_to_f_string_cptr(checksum_c_str)
...
function Checksum__execute_real32_r1(this, loc_field_data) result(checksum)
  ...
  lextents = (/ 1                        /)
  checksum_c_str = atlas__Checksum__execute_strided_float( this%private%object, &
    &  loc_field_data, lstrides, lextents, lrank )
  checksum = c_to_f_string_cptr(checksum_c_str)
...
function Checksum__execute_real64_r1(this, loc_field_data) result(checksum)
  ...
  lstrides = (/ stride(loc_field_data,1) /)
  lextents = (/ 1                        /)
  checksum_c_str = atlas__Checksum__execute_strided_double( this%private%object, &
    &  loc_field_data, lstrides, lextents, lrank )
  checksum = c_to_f_string_cptr(checksum_c_str)
