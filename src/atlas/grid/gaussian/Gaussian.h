...
#ifndef atlas_grid_ReducedGaussianGrid_h
#define atlas_grid_ReducedGaussianGrid_h
...
class Gaussian: public Structured {
  ...
  protected:
    ...
    void setup_N_hemisphere(const size_t N, const long pl[], const domain::Domain& dom);
