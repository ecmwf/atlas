...
#include "atlas/grid/detail/grid/regular/RegularRegional.h"
...
void RegularRegional::setup( const Config& config ) {
...
RegularRegional::RegularRegional( const Config& config ) :
    Regular() {
    setup(config);
}
