...
Structured* atlas__grid__reduced__StretchedRotatedReducedGaussian_int( int nx[], long ny, double centre[], double stretch, double angle );
Structured* atlas__grid__reduced__StretchedRotatedReducedGaussian_long( long nx[], long ny, double centre[], double stretch, double angle );
