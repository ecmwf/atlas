...
///
///    CustomSpacing( 4, {75,25,-25,-75} )                  -->  { 75 , 25 , -25
///    , -75 }
///    CustomSpacing( 4, {75,25,-25,-75}, {-90,90} )        -->  { 75 , 25 , -25
///    , -75 }
///
/// The optional argument {min,max} serves as purpose to indicate that the
/// points
/// lie in the open interval (min,max). If not specified, the default values are
/// taken
/// to be the North and South pole's latitudes.
///
/// Configuration parameters can be passed as well with following keys:
///
///    {"N":4, "values":[75,25,-25,75] }                        -->  { 75 , 25 ,
///    -25 , -75 }
///    {"N":4, "values":[75,25,-25,75], "interval":[-90,90] }   -->  { 75 , 25 ,
///    -25 , -75 }
