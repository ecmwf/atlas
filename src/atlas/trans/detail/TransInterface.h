...
void atlas__Trans__invtransadj( const TransImpl* t, int nb_scalar_fields, double gp_fields[], int nb_vordiv_fields,
...
void atlas__Trans__invtransadj_fieldset( const TransImpl* This, const field::FieldSetImpl* gpfields,
                                      field::FieldSetImpl* spfields, const eckit::Configuration* parameters );
void atlas__Trans__invtransadj_field( const TransImpl* This, const field::FieldImpl* gpfield, field::FieldImpl* spfield,
                                   const eckit::Configuration* parameters );
