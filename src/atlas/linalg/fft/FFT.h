...
public:
    ...
    virtual void do_prepare_inverse_c2r_many(size_t howmany, size_t size_in, size_t size_out, size_t dist_in, size_t dist_out, std::complex<double>* in, double* out) const = 0;
    ...
    virtual void do_prepare_inverse_c2r(size_t size_out, std::complex<double>* in, double* out) const = 0;
    virtual void do_inverse_c2r(size_t size_out, std::complex<double>* in, double* out) const = 0;

    void prepare_inverse_c2r_many(size_t howmany, size_t size_in, size_t size_out, size_t dist_in, size_t dist_out, std::complex<double>* in, double* out) const {
        do_prepare_inverse_c2r_many(howmany, size_in, size_out, dist_in, dist_out, in, out);
    }
    void prepare_inverse_c2r_many(
        ...
        do_prepare_inverse_c2r_many(howmany, size_in, size_out, dist_in, dist_out, in.data_handle(), out.data_handle());
    }
    void prepare_inverse_c2r_many(size_t howmany, size_t size_out, std::complex<double>* in, double* out) const {
    ...
    void prepare_inverse_c2r(size_t size_out, std::complex<double>* in, double* out) {
        do_prepare_inverse_c2r(size_out, in, out);
    }
...
public:
    ...
    FFTW();
    virtual ~FFTW();
    void do_prepare_inverse_c2r_many(size_t howmany, size_t size_in, size_t size_out, size_t dist_in, size_t dist_out, std::complex<double>* in, double* out) const override;
    ...
    void do_prepare_inverse_c2r(size_t size_out, std::complex<double>* in, double* out) const override;
