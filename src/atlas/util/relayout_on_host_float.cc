...
/**
 * @file relayout_on_host_float.cc
 * @brief Explicit template instantiations of host relayout functions for float.
 *
...
#define EXPLICIT_TEMPLATE_INSTANTIATION(RANK) \
    ATLAS_RELAYOUT_EXPLICIT_TEMPLATE_INSTANTIATION_TYPE_RANK(float, RANK)
