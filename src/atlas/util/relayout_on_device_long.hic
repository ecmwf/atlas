...
/**
 * @file relayout_on_device_long.hic
 * @brief Explicit template instantiations of device relayout functions for long.
 *
...
#define EXPLICIT_TEMPLATE_INSTANTIATION(RANK) \
    ATLAS_RELAYOUT_DEVICE_EXPLICIT_TEMPLATE_INSTANTIATION_TYPE_RANK(long, RANK)
