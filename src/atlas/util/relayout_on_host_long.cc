...
/**
 * @file relayout_on_host_long.cc
 * @brief Explicit template instantiations of host relayout functions for long.
 *
...
#define EXPLICIT_TEMPLATE_INSTANTIATION(RANK) \
    ATLAS_RELAYOUT_EXPLICIT_TEMPLATE_INSTANTIATION_TYPE_RANK(long, RANK)
