...
MethodBuilder<Linear3D> __builder2("structured-trilinear");
MethodBuilder<Linear3D> __builder1("structured-linear3D", FactoryDeprecated("Please use structured-trilinear"));
