...
MethodBuilder<Linear2D> __builder2("structured-bilinear");
MethodBuilder<Linear2D> __builder1("structured-linear2D", FactoryDeprecated("Please use structured-bilinear"));
