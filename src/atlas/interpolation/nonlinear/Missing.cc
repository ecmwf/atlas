...
bool MissingIfAllMissing::execute(NonLinear::Matrix& W, const Field& field, const array::Array& array) const {
    switch(field.datatype().kind()) {
...
template<typename T>
bool MissingIfAllMissing::executeT(NonLinear::Matrix& W, const Field& field, const array::Array& array) const {
