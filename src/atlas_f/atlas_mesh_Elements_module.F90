...
module atlas_mesh_Elements_module
...
! Public methods
  ...
  procedure, public :: delete   => atlas_mesh_Elements__delete

  procedure, public :: size     => atlas_mesh_Elements__size
  procedure, public :: begin => atlas_mesh_Elements__begin
  procedure, public :: end   => atlas_mesh_Elements__end
...
interface atlas_mesh_Elements
  module procedure atlas_mesh_Elements__cptr
end interface
...
function atlas_mesh_Elements__cptr(cptr) result(elements)
  type(atlas_mesh_Elements) :: elements
  type(c_ptr), intent(in) :: cptr
  call elements%reset_c_ptr( cptr )
end function

subroutine atlas_mesh_Elements__delete(this)
  use atlas_elements_c_binding
  class(atlas_mesh_Elements), intent(inout) :: this
...
subroutine atlas_mesh_Elements__copy(this,obj_in)
  class(atlas_mesh_Elements), intent(inout) :: this
  class(atlas_RefCounted),   target, intent(in) :: obj_in
end subroutine


function atlas_mesh_Elements__size(this) result(val)
  use atlas_elements_c_binding
  integer(c_size_t) :: val
  class(atlas_mesh_Elements), intent(in) :: this
...
function element_type(this) result(etype)
  use atlas_elements_c_binding
  class(atlas_mesh_Elements), intent(in) :: this
  type(atlas_mesh_ElementType) :: etype
  etype = atlas_mesh_ElementType( &
...
function atlas_mesh_Elements__begin(this) result(val)
  use atlas_elements_c_binding
  integer(c_size_t) :: val
  class(atlas_mesh_Elements), intent(in) :: this
...
function atlas_mesh_Elements__end(this) result(val)
  use atlas_elements_c_binding
  integer(c_size_t) :: val
  class(atlas_mesh_Elements), intent(in) :: this
...
end module atlas_mesh_Elements_module
