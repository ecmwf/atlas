...
private :: fckit_refcounted, atlas_Config, atlas_code_location, atlas_abort, atlas_throw_outofrange
...
subroutine array_c_to_f_int32_r1(array_cptr,rank,shape_cptr,strides_cptr,array_fptr)
  ...
  if( rank /= 1 ) call atlas_abort("Rank mismatch",atlas_code_location("atlas_Field_module.F90",146))
...
subroutine array_c_to_f_int32_r2(array_cptr,rank,shape_cptr,strides_cptr,array_fptr)
  ...
  if( rank /= 2 ) call atlas_abort("Rank mismatch",atlas_code_location("atlas_Field_module.F90",146))
...
subroutine array_c_to_f_int32_r3(array_cptr,rank,shape_cptr,strides_cptr,array_fptr)
  ...
  if( rank /= 3 ) call atlas_abort("Rank mismatch",atlas_code_location("atlas_Field_module.F90",146))
...
subroutine array_c_to_f_int32_r4(array_cptr,rank,shape_cptr,strides_cptr,array_fptr)
  ...
  if( rank /= 4 ) call atlas_abort("Rank mismatch",atlas_code_location("atlas_Field_module.F90",146))
...
integer function atlas_real(kind)
  ...
  if (kind == c_double) then
    ...
    call atlas_abort("Unsupported real kind",atlas_code_location("atlas_Field_module.F90",222))
  end if
end function
...
integer function atlas_integer(kind)
  ...
  if ( present(kind) ) then
    if (kind == c_int) then
      ...
      call atlas_abort("Unsupported real kind",atlas_code_location("atlas_Field_module.F90",238))
    end if
  end if
end function
...
function atlas_data_type(kind)
  ...
  if( kind == ATLAS_KIND_INT32 ) then
    ...
    call atlas_abort("cannot convert kind to data_type",atlas_code_location("atlas_Field_module.F90",264))
  endif
end function
