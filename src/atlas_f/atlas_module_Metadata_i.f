...
contains
  ...
  procedure, private :: set_grid => Metadata__set_grid
  procedure, private :: set_function_space => Metadata__set_function_space
  procedure :: has => Metadata__has
  generic :: set => set_logical, set_int32, set_real32, set_real64, set_string, set_array_int32, &
    set_array_int64, set_array_real32, set_array_real64, set_mesh, set_grid, set_function_space
  ...
  procedure :: get_grid => Metadata__get_grid
  procedure :: get_function_space => Metadata__get_function_space
  generic :: get => get_int32, get_logical, get_real32, get_real64, get_string, get_array_int32, &
    get_array_int64, get_array_real32, get_array_real64, get_mesh, get_grid, get_function_space
