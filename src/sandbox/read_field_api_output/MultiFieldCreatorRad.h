 ...
 * \endcode
 */
class MultiFieldCreatorRad : public MultiFieldCreator {
public:
    MultiFieldCreatorRad();
    MultiFieldCreatorRad(const eckit::Configuration& config);
    ~MultiFieldCreatorRad() override;
